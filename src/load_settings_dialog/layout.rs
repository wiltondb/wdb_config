...
#[derive(Default)]
pub(super) struct LoadSettingsDialogLayout {
    root_layout: nwg::FlexboxLayout,
    buttons_layout: nwg::FlexboxLayout,
}

impl ui::Layout<LoadSettingsDialogControls> for LoadSettingsDialogLayout {
    fn build(&self, c: &LoadSettingsDialogControls) -> Result<(), nwg::NwgError> {
